...
public class D3Test {
  ...
  public void tEST1LINKS() {
    ...
    vars.put("currentPath", js.executeScript("return window.location.pathname;"));
    assertEquals(vars.get("currentPath").toString(), "/reset");
  }
  @Test
  ...
  public void tEST3CATALOG() {
    ...
    {
      WebElement element = driver.findElement(By.xpath("//li[2]//img[@alt=\"Old Deuteronomy\"]"));
      String attribute = element.getAttribute("src");
      vars.put("cat2", attribute);
    }
   assertEquals(vars.get("cat2").toString(),"http://localhost:8080images/cat2.jpg");
  }
  ...
  public void tEST4LISTING() {
    driver.get("http://localhost:8080");
    driver.findElement(By.linkText("Catalog")).click();
    vars.put("catCount", driver.findElements(By.xpath("//ul[@class=\"list-group\"]/li")).size());
